...
import { useAddSubcategoriesToRoleMutation } from "@/redux/services/roles/roles.service"
...
const AddSubcategories = (props: IModal) => {
    ...
    const { id } = role
    const [addSubcategoriesToRole, { data, error, isLoading }] = useAddSubcategoriesToRoleMutation()
